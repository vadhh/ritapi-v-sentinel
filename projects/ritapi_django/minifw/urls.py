...
urlpatterns = [
    ...
    path('api/events/datatable/', views.minifw_api_events_datatable, name='minifw_api_events_datatable'),
    path('api/events/export/', views.minifw_api_events_export, name='minifw_api_events_export'),

    # API — Audit Logs
    path('api/audit/logs/', views.minifw_api_audit_logs, name='minifw_api_audit_logs'),
    path('api/audit/statistics/', views.minifw_api_audit_statistics, name='minifw_api_audit_statistics'),
    path('api/audit/export/', views.minifw_api_audit_export, name='minifw_api_audit_export'),

    # API — User Management
    path('api/users/', views.minifw_api_users_list, name='minifw_api_users_list'),
    path('api/users/create/', views.minifw_api_users_create, name='minifw_api_users_create'),
    path('api/users/<int:user_id>/', views.minifw_api_users_update, name='minifw_api_users_update'),
