...
class TestBlockingViews(APITestCase):
    ...
    def test_list_blocked_ips_view(self):
        ...
        BlockedIP.objects.create(
            ip_address="1.1.1.1", reason="Test 1", severity="high", active=True
        )
        BlockedIP.objects.create(
            ip_address="2.2.2.2", reason="Test 2", severity="low", active=False
        )  # Harus diabaikan
        BlockedIP.objects.create(
            ip_address="3.3.3.3", reason="Test 3", severity="critical", active=True
        )
